...
from stable_baselines import SAC, TD3, TRPO
...
if __name__ == '__main__':
	...
	model = TD3(TD3Policy, env, gamma=0.99, learning_rate=1e-4, buffer_size=100000, learning_starts=100,
				...
				_init_setup_model=True, policy_kwargs={'layers': [50, 50]},
	...
	callback_chkpt = CheckpointCallback(save_freq=1000, save_path=os.path.join('models', model_name), name_prefix=model_name)
